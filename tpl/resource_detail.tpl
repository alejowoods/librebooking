<script type="text/javascript">
    function init() {
        // Resource detail page - no additional initialization needed
    }
</script>
    ...
    {else}
        <div class="card shadow">
            ...
            <div class="card-body">
                ...
                <div class="row mt-3">
                    <div class="col-12">
                        <h5 class="border-bottom pb-2">{translate key='CustomAttributes'}</h5>
                        <div class="row">
                            {foreach from=$Attributes item=attribute name=attributes}
                                <div class="customAttribute col-sm-4 col-12 mb-2">
